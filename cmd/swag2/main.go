...
const (
	...
	parseAllCommentFlag  = "parseAllComment"
	parseDisplayFlag     = "parseDisplayFlag"
...
var initFlags = []cli.Flag{
	...
	&cli.BoolFlag{
		Name:    parseAllCommentFlag,
		Aliases: []string{"a"},
		Usage:   "Parse go files for routers outsize of function comment",
	},
	&cli.BoolFlag{
		Name:    parseDisplayFlag,
		Aliases: []string{"show"},
		Usage:   "Show Parse go files ",
	},
	&cli.StringFlag{
...
func initAction(c *cli.Context) error {
	...
	return gen.New().Build(&gen.Config{
		...
		DisplayScanFile:     c.Bool(parseDisplayFlag),
		ParseAllComment:     c.Bool(parseAllCommentFlag),
