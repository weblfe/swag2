...
OPTIONS:
   ...
   --parseAllComment, -a               是否启用 解析go源文件中 非函数注释块 默认不
   --parseDisplayFlag, --show          是否启用 展示解析 go源文件名 默认不
...
This project was inspired by [yvasiyarov/swagger](https://github.com/yvasiyarov/swagger) but we simplified the usage and
added support a variety of [web frameworks](#supported-web-frameworks). Gopher image source
is [tenntenn/gopher-stickers](https://github.com/tenntenn/gopher-stickers). It has
licenses [creative commons licensing](http://creativecommons.org/licenses/by/3.0/deed.en).
...
website. [[Become a sponsor](https://opencollective.com/swag#sponsor)]
